...
function initTopNavigation() {
  ...
  if (helpButton) {
    helpButton.addEventListener("click", () => {
      ...
      // In a real implementation, this would open a help modal or redirect to help pages
    })
  }
  ...
  if (notificationButton) {
    notificationButton.addEventListener("click", () => {
      ...
      // In a real implementation, this would open a notifications dropdown
    })
  }
  ...
  if (settingsButton) {
    settingsButton.addEventListener("click", () => {
      ...
      // In a real implementation, this would open a settings modal or redirect to settings page
    })
  }
  ...
  if (userProfileDropdown) {
    userProfileDropdown.addEventListener("click", () => {
      ...
      // In a real implementation, this would open a user profile dropdown
    })
  }
...
// Initialize Charts
function initCharts() {
  // Check if Chart.js is loaded and if there are chart canvases on the page
  if (typeof Chart !== "undefined") {
    // Enrollments Chart
    const enrollmentsChartEl = document.getElementById("enrollmentsChart")
    if (enrollmentsChartEl) {
      const enrollmentsChart = new Chart(enrollmentsChartEl, {
        type: "line",
        data: {
          ...
          datasets: [
            ...
            },
            {
              ...
              data: [42, 55, 72, 75, 82, 95],
              borderColor: "rgb(30, 78, 122)",
              backgroundColor: "rgba(30, 78, 122, 0.1)",
              tension: 0.3,
              fill: true,
            },
          ],
    ...
    if (efficiencyChartEl) {
      const efficiencyChart = new Chart(efficiencyChartEl, {
        type: "doughnut",
        data: {
          labels: ["Auto-Processed", "Manual Review"],
          datasets: [
            {
              data: [75, 25],
    ...
    const clientDistributionChartEl = document.getElementById("clientDistributionChart")
    if (clientDistributionChartEl) {
      const clientDistributionChart = new Chart(clientDistributionChartEl, {
        type: "bar",
        data: {
          labels: ["Healthcare", "Technology", "Manufacturing", "Retail", "Services"],
          datasets: [
            {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (userProfileDropdown) {
    userProfileDropdown.addEventListener("click", () => {
      alert("User profile options will open here.")
      // In a real implementation, this would open a user profile dropdown
    })
  }
...
function initializeCharts() {
  // Check if Chart.js is loaded and if there are chart canvases
  if (typeof Chart !== "undefined") {
